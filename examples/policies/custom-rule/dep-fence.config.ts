...
// Demonstrates a lightweight custom runtime rule embedded in a policy
...
// Guidance
// OK: package.json contains { "repository": { "type": "git", "url": "..." } }
// NG: repository field missing — will emit a WARN finding with a clear Because reason.
